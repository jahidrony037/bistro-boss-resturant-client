...
const CommonBanner = ({ title, description }) => {
  return (
    <div className="bg-[url('https://i.ibb.co/b5B3dyS/b32bc60bcd909b6c46c7cc29fa0aa2fc-Expires-1716768000-Key-Pair-Id-APKAQ4-GOSFWCVNEHN3-O4-Signature-Kfa.jpg')] bg-no-repeat bg-center bg-cover h-[572px] flex items-center justify-center mt-[100px]">
      <div className="bg-[#FFF]  mx-[18%] py-[60px] px-[45px]">
        <h2 className="text-[#151515] font-normal text-[45px] text-center">
          {title}
        </h2>
        <p className="text-[16px] text-center font-normal text-[#151515]  w-full mx-auto">
          {description}
        </p>
      </div>
    </div>
